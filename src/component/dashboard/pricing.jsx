  ...
  return (
    ...
    <Navbar/>
      <section className="text-gray-600 body-font overflow-hidden bg-gray-100">
        <div className="-mt-1 container px-5 py-14 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col overflow-hidden">
                ...
                You cannot cancel anytime for any reason money will not refund.
                </p>
              </div>
            </div>
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
              <div className="h-full p-6 rounded-lg border-2 border-indigo-500 flex flex-col relative overflow-hidden">
                ...
                <p className="text-xs text-gray-500 mt-3">
                  You can cancel anytime for any reason money will refund according to T&C.
                </p>
              </div>
            </div>
            <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
