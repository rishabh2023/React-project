...
export default function Email() {
    ...
    const onSubmit = async (data, e) => {
        ...
        const payload_data = Object.assign({}, data, cpassword);



        setregistering('logging In')
        await axios.post("/register/", payload_data
    ...
    const check_email = async() =>{
        ...
        email_payload['email'] = data_email
       
        await axios.post("/verification/", email_payload
                        ...
                        >
                            <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                                ...
                                <div className="mt-2">
                                    ...
                                    <div className='text-red-600 text-base text-justify'>
                                        Email is already present try it with different one!!
                                    ...
                                    <div className="max-w-sm mx-auto md:max-w-lg">
                                        <div className="w-full">
                                            <div className="bg-white h-64 py-3 rounded text-center">
                                                ...
                                                <div className="flex flex-col mt-4"> <span>Enter the OTP you received at</span> <span className="font-bold">{data_email}</span> </div>
